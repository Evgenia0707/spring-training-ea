...
public interface TicketRepository extends JpaRepository<Ticket, Long> {
    ...
    List<Ticket> findAllByUserAccountEmail(String email);//(join user and ticket tables)  email inside user account
...
//from ticket
   ...
   //Write a native query to count the number of tickets a user bought in a specific range of dates
    ...
    //join tables (name coming from movie; ticket)
    ...
    //join (ticket, acc, movieCinema, user, movie)
