...
@RestController
public class Consume_FeignClient {//need have DTO
    ...
    @GetMapping("/api/v1/users")//localhost:8080/api/v1/users
    public ResponseEntity<ResponseWrapper> getUsers(){
        return ResponseEntity.ok(new ResponseWrapper("UserList Retrieved",userClient.getUsers()));  //what see (userClient.getUsers) data - output for client List<User>
}
